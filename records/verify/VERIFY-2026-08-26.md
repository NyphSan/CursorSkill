...
- `w-zhian/game-design-skills`：api err 403
- `ityes22/game-design-document`：api err 403
- `makesupply/lodestar-skill`：文件是 MIT，GitHub SPDX=NOASSERTION
- `kevinpbuckley/unreal-engine-skills`：原仓无 GitHub 可识别 LICENSE（404）
- `dstn2000/claude-unreal-engine-skill`：api err 403
